...
## Encoding/Encryption (embedder.py):


## Handles the embedding of secret messages into host images
## Uses bit plane manipulation for embedding
## Implements various encoding strategies through chromosome parameters
## Has error handling for insufficient stego capacity