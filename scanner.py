...
##Implements various scanning patterns (raster, zigzag, etc.)
##Provides methods to traverse images in different directions
##Crucial for both embedding and extraction processes