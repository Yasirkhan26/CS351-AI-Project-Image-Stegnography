...
# Image Processing and Main Logic (genstego.py):


#This is the main script that orchestrates the steganography process
#Contains functions for embedding, decoding, and displaying images
#Implements a genetic algorithm to optimize the embedding process
#Uses PSNR (Peak Signal-to-Noise Ratio) as a fitness metric