...
##helper_individual.py:


##Manages chromosome representation
##Handles initialization and conversion of genetic parameters
##Supports the genetic algorithm implementation